 ...
 sensors = [
  {
   ...
   state: "string",
   topic_name:
    "Home 853dcfba7f-d1eb-4e0f-9c30-7c4fa38c07ea/deveeice 0ww1/sensor device 9",
   type: "temperature",
  ...
  },
  {
   ...
   state: "string",
   topic_name:
    "Home 85ead0621f-344b-4bec-ac67-1c6189d5e560/deveeice 0ww1/sensor 00 device 9",
   type: "temperature",
  ...
  },
  {
   ...
   state: "string",
   topic_name:
    "Home 85d0eaa0dd-e930-4f5d-b381-b079b3669a0e/device 1/sensor 00 device 10",
   type: "temperature",
  ...
  },
  {
   ...
   state: "string",
   topic_name:
    "Home 857084cc99-e73b-4ac3-a198-961f7006657f/device 1/sensor 55 device 10",
   type: "temperature",
 ...
 return (
  <View style={style.allSensors}>
   <ScrollView showsVerticalScrollIndicator={false}>
     ...
     return (
      deviceId == sensor.device && (
       <TouchableOpacity
        ...
        activeOpacity={0.7}
        onPress={() =>
         navigation.navigate("Sensor details", {
          label: sensor.created_at.slice(0, 10),
          type: sensor.type,
          state: sensor.state.split(" "),
         })
        }
        key={sensor.id}
       >
        <View style={style.sensor}>
         <Text style={style.sensorName}>{sensor.name}</Text>
         <Text style={style.sensorName}>{sensor.type}</Text>
        </View>
       </TouchableOpacity>
      )
     );
    ...
    >
     <View style={style.sensor}>
      <Text style={style.sensorName}>Зал</Text>
      <Text style={style.sensorName}>22° C</Text>
     </View>
    </TouchableOpacity>
