...
export default function HomeDrops({
    ...
    return (
        <View style={style.main} >
            ...
            >
                <Text style={style.title} >{!!selectedItem ? selectedItem?.name : "Choose home"}</Text>
                <Image style={{
                            ...
                            {listOfHomes.map((home, i) => {
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={[style.homeDrops, {
                                            backgroundColor: selectedItem? selectedItem.created_at : false == home.created_at ? "rgba(100, 24, 37, 0.7)" : "#3b4165",
                                        }]}
                                        activeOpacity={0.8}
                                    >
