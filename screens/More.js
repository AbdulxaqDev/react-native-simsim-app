import {
  View, Text, StyleSheet, SafeAreaView, TouchableOpacity, Image, Dimensions,
  ActivityIndicator,
  Alert
} from 'react-native';
  ...
  return (
    <>
      <SafeAreaView style={style.container} >
        ...
        <View>
          <TouchableOpacity style={style.moreOptionWrapper}
          ...
          <TouchableOpacity style={[style.moreOptionWrapper, { marginBottom: 170 }]}
